...
// @ts-expect-error - generated worker entry only exists after `astro build`.
const astroWorker = (await import("../dist/_worker.js/index.js")).default as {
...
export default {
	async fetch(request: Request, env: CloudflareEnv, ctx: CloudflareExecutionContext): Promise<Response> {
